...
/*======================================
        06. Work load more JS
========================================*/
$(document).ready(function () {
    let $wrapper = $(".initial-items");
    if (!$wrapper.length) return;

    let limit = parseInt($wrapper.data("limit"));
    let $items = $(".block-items");
    let $loadMoreBtn = $(".all-btn");
    let $loader = $loadMoreBtn.find(".animate-spin");
    ...
    $loadMoreBtn.on("click", function (e) {
        ...
        // Allow loader to render before showing items
